...
# library(nlme)   # package for function lmList  moved to top
    ...
    keeling.results <- data.table(keeling.offset.d15Na,keeling.slope.d15Na,keeling.R2.d15Na,keeling.offset.d15Nb,keeling.slope.d15Nb,keeling.R2.d15Nb,
                                  keeling.offset.d18O,keeling.slope.d18O,keeling.R2.d18O)
...
# library(nlme)   # package for function lmList  -> moved to top
   ...
   fwrite(keeling.results,"output/keeling-results.csv",sep=",") # write keeling plot results

...
SPAN   = DATA$VICI == 4 & DATA$hourinseconds > 480 & DATA$TIMESTAMP > as.POSIXct("2015-12-05 00:00:00, tz=UTC")
...
pdf("/Users/mbarthel/Desktop/QCL1/graphs/anchor.pdf",encoding="MacRoman",height=6,width=12,family="Times",fonts="Times")   
...
plot(DATA$TIMESTAMP[ANCHOR],DATA$d15Nb.corr2[ANCHOR],ylim=c(-20,60),col="white",xlab='Time [months]', ylab=expression(paste(delta^{15},N[beta])),
  xlim=c(as.POSIXct("2015-12-06 00:00:00, tz=UTC"),as.POSIXct("2016-01-28 00:00:00, tz=UTC")))
...
# ===============================================================================================================================================================================================================================================
# FLUX CALCULATIONS based on Betsys Excel spreadsheet
